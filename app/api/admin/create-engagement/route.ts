    ...
    .upsert(
      {
        ...
        client_signatory_first_name: engagement.clientSignatoryFirstName,
        client_signatory_last_name: engagement.clientSignatoryLastName,
        client_signatory_name: `${engagement.clientSignatoryFirstName} ${engagement.clientSignatoryLastName}`.trim(),
