...
const ICON_COLOR_PRESETS = [
  { bg: "#F3FDBF", text: "#008031" },
  { bg: "#EAF8FC", text: "#3538E7" },
  { bg: "#FFD6EC", text: "#F23400" },
  { bg: "#100F14", text: "#FFD6EC" },
];
            ...
            <div className="col-span-2">
              ...
              <div className="flex gap-2 mt-1">
                {ICON_COLOR_PRESETS.map((preset) => {
                  const isSelected =
                    member.iconBgColor === preset.bg &&
                    member.iconTextColor === preset.text;
                  return (
                    <button
                      key={preset.bg}
                      type="button"
                      onClick={() => {
                        updateTeamMember(i, "iconBgColor", preset.bg);
                        updateTeamMember(i, "iconTextColor", preset.text);
                      }}
                ...
                <button
                  type="button"
                  onClick={() => {
                    updateTeamMember(i, "iconBgColor", "");
                    updateTeamMember(i, "iconTextColor", "");
                  }}
