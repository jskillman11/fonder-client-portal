...
export function ReviewAndSignList({
  ...
  const docs = [
    hasSow && {
      ...
      description: "Scope, deliverables, timeline, and fees for this engagement.",
    },
    hasMsa && {
      key: "msa",
      label: "Master Services Agreement",
      description: "The general terms that govern this and future engagements.",
    },
  ...
  return (
    <Card className="px-9 py-9 md:px-12 md:py-10">
      ...
      <p className="text-[14px] text-[var(--color-muted)] mb-6">
        Each document below is reviewed and signed separately.
      </p>
